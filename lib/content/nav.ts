...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    simple: [
      ...
      { label: 'AI Consulting', href: '/consultancy/ai-consulting', desc: 'Where and how AI fits your product' },
      { label: 'Product Consulting', href: '/consultancy/product-consulting', desc: 'Scope · MVP · roadmap' },
      { label: 'Digital Transformation', href: '/consultancy/digital-transformation', desc: 'Modernise operations with software' },
      { label: 'Architecture Review', href: '/consultancy/architecture-review', desc: 'Audit your current system for risk' },
      { label: 'IT Outsourcing Advisory', href: '/consultancy/outsourcing-advisory', desc: 'Build vs buy · vendor selection' },
      { label: 'Security & Compliance Review', href: '/consultancy/security-compliance', desc: 'OWASP · data-protection readiness' },
      { label: 'Fractional CTO', href: '/consultancy/fractional-cto', desc: 'Senior technical leadership on demand' },
    ],
  },
  {
    label: 'Industries',
