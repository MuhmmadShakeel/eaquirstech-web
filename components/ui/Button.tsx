...
const base =
  ...
  'transition-all duration-fast disabled:opacity-50 disabled:pointer-events-none whitespace-nowrap';

const variants: Record<Variant, string> = {
  primary: 'rounded-pill bg-amber text-white hover:bg-amber-bright shadow-sm hover:shadow-amber active:bg-amber-mid',
...
const sizes: Record<Size, string> = {
  ...
  lg: 'h-13 px-8 text-body-sm md:text-body',
};
